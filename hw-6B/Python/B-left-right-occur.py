...
def left_binsearch(l, r, params, check):
    arr, L = params
    while l < r:
        m = l + (r - l) // 2
        if check(arr, m, L):
...
def right_binsearch(l, r, params, check):
    arr, R = params
    while l < r:
        m = (l + r + 1) // 2
...
if __name__ == '__main__':
    ...
    for t in targets:
        left = left_binsearch(0, n - 1, (arr, t), check_ge) + 1
        right = right_binsearch(0, n - 1, (arr, t), check_gt) + 1
